...
#define      OV7725_VSYNC_GPIO_PORT                   GPIOE
#define      OV7725_VSYNC_GPIO_PIN                    GPIO_Pin_5

#define      OV7725_VSYNC_EXTI_SOURCE_PORT            GPIO_PortSourceGPIOE
#define      OV7725_VSYNC_EXTI_SOURCE_PIN             GPIO_PinSource5
#define      OV7725_VSYNC_EXTI_LINE                   EXTI_Line5
